          ...
          {experiences.map((exp, index) => (
            <div
              ...
              <div
                ...
                w-12 h-12 bg-emerald-500 rounded-full border-4 border-[#1A1A1A] 
                shadow-lg shadow-emerald-500/50 animate-pulse"></div>

              <div
                className={`w-1/2 bg-[#2A2A2A] rounded-2xl shadow-2xl border-2 border-emerald-500/30 
                  transform transition-all duration-500 hover:scale-[1.03] hover:shadow-emerald-500/30
                  p-8 space-y-4 relative overflow-hidden
                ...
                <div className="relative z-10">
                  <div className="flex items-center mb-4">
                    <FaBriefcase className="text-emerald-400 mr-4 text-3xl" />
                    <div>
                      <h3 className="text-3xl font-bold text-emerald-400">
                        {exp.title}
                      </h3>
                      <p className="text-emerald-300 text-xl">{exp.company}</p>
                    </div>
                  </div>
